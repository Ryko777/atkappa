<?php /* Smarty version 2.6.11, created on 2014-04-01 09:53:27
...
<?php endif;  if (! empty ( $this->_tpl_vars['index'] ) || ! empty ( $this->_tpl_vars['editcontrol'] )): ?>
  <tr>
...
<?php endif;  if (! empty ( $this->_tpl_vars['list'] )): ?>
<tr>
  <td align="left" valign="top" colspan="2">
...
<?php endif;  if (! empty ( $this->_tpl_vars['norecordsfound'] )): ?>
  <tr>
    <td align="left" valign="top">
...
<?php endif;  if (! empty ( $this->_tpl_vars['paginator'] ) || ! empty ( $this->_tpl_vars['summary'] )): ?>
  <tr>
    <td align="left" valign="middle">
...
<?php endif;  if (! empty ( $this->_tpl_vars['bottom'] )): ?>
<tr>
  <td align="left" valign="top" colspan="2">
